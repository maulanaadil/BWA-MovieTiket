package com.maulnad.bwamov.home.dashboard
...
import com.maulnad.bwamov.DetailActivity
    ...
    private fun getData(){
        mDatabase.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                dataList.clear()
                for (getdataSnaphot in dataSnapshot.getChildren()) {

                    val film = getdataSnaphot.getValue(Film::class.java!!)
                    dataList.add(film!!)
                }
